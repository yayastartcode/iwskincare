...
export const metadata: Metadata = {
  title: 'Gabung Menjadi Agen',
  description: 'Dapatkan penghasilan tambahan dengan menjadi agen resmi',
}
      ...
      <section className="relative">
        {heroImageUrl ? (
          <div className="relative h-[300px] md:h-[400px]">
            <Image
              src={heroImageUrl}
              alt={data.title || 'Gabung Menjadi Agen'}
              fill
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="px-6 text-center">
                <h1 className="text-4xl font-bold text-white md:text-5xl">
                  {data.title || 'Gabung Menjadi Agen'}
                </h1>
                {data.subtitle && (
        ...
        <section className="px-6 py-16">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-8 text-center text-3xl font-bold text-[#5C5346]">
              {data.requirements.title || 'Syarat Menjadi Agen'}
            </h2>
